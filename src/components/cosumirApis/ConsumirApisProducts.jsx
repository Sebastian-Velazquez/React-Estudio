...
class ConsumirApisProducts extends Component {
    ...
    componentDidMount(){
        ...
        this.apiCall("http://localhost:3001/api/products", this.mostrarUsuario)
    }
    ...
    mostrarUsuario = (data) =>{
        ...
        this.setState(
            {
                apiUsario: data.data.map( (imprimir, i) => imprimir = <p key={imprimir.name + i}>{imprimir.name}</p> 
...
export default ConsumirApisProducts
